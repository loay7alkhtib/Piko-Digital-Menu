...
-- First, let's update existing categories and add new ones
...
-- First ensure categories exist, then add translations
INSERT INTO categories (slug, sort_order, is_active) VALUES
  ('smoothies', 3, true),
  ('bubble-drinks', 4, true),
  ('cold-drinks', 5, true),
...
-- Update existing category translations
