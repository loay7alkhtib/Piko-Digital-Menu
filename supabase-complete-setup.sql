-- ========================================
-- PIKO DIGITAL MENU - COMPLETE DATABASE SETUP
...
CREATE INDEX IF NOT EXISTS idx_category_i18n_locale ON category_i18n(locale);
CREATE INDEX IF NOT EXISTS idx_items_category_id ON items(category_id);
CREATE INDEX IF NOT EXISTS idx_items_sort_order ON items(sort_order);
CREATE INDEX IF NOT EXISTS idx_items_active ON items(is_active);
CREATE INDEX IF NOT EXISTS idx_item_i18n_locale ON item_i18n(locale);
CREATE INDEX IF NOT EXISTS idx_item_prices_item_id ON item_prices(item_id);
CREATE INDEX IF NOT EXISTS idx_item_prices_active ON item_prices(is_active);
...
-- 2. Create a user or note an existing user ID
-- 3. Run this query to make them staff:
--    INSERT INTO profiles (id, email, role) 
--    VALUES ('USER_ID_HERE', 'email@example.com', 'staff');

SELECT 'Database setup complete! Ready to use Piko Digital Menu.' as status;
